...
export default function SectionHeader({
  ...
  return (
    ...
    >
      {subtitle && (
        <p 
          className={`text-violet-600 dark:text-violet-400 font-semibold text-sm uppercase tracking-wider mb-3 transition-all duration-500 ${
      ...
      <div 
        className={`w-20 h-1.5 bg-violet-500 rounded-full ${decoratorAlignment[align]} transition-all duration-700 delay-200 ${
